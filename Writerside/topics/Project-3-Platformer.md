...
_In this entry, I discuss how source control enabled collaboration and saved the entire project, and how I might improve my usage in the future._
...
The first one is the project we've been talking about (I created the "pre-tragedy" branch later,
once I was able to recover the code left on the dead laptop).
...
In the future, I should use branches, but only where appropriate; they can be very useful for reasons mentioned 
previously, but if used too liberally, can over-complicate the project.
